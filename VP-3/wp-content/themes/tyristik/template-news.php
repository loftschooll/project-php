...
$article_args = array('post_type' => 'post', 'category_name'=>'news', 'posts_per_page' => 5, 'order'=>'DESC', 'paged' => $current_page); // 10 записей
...
<div class="main-content">
    <div class="content-wrapper">
        <div class="content">
            <h1 class="title-page">Новости из мира туризма</h1>
