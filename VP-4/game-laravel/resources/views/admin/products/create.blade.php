                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/products/create') }}" name="add_product" id="add_product" novalidate="novalidate">
                                {{ csrf_field() }}
